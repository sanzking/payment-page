...
table, th tr, td {
  ...
  <div class="container justify-content-center">
    <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
      <center><img src="https://theme.zdassets.com/theme_assets/1379487/2cb35fe96fa1191f49c2b769b50cf8b546fff65e.png" height="100" width="100" class="mb-2"><br><h1 class="mb-3">OVO PAYMENT</h1></center>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
         ...
         <div class="input-group mb-2" align="center">
            <span class="input-group-text" id="basic-addon1" style="background: blue;color:white;border:1px solid black;">OVO</span>
            <input type="text" class="form-control p-1 text-center" style="border:1px solid black;" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" value="081320733964" disabled>
            </div>
          ...
          function chek(){
            ...
            if($error === 4){
              ...
              if ( !in_array($ex, $extensi) ){
                ...
                $main = $ssl.$web."/pay/pembayaran/ovo/uploads/".$namenew;
