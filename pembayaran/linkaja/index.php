...
table, th tr, td {
  ...
  <div class="container justify-content-center">
    <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
      <center><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/LinkAja.svg/1200px-LinkAja.svg.png" height="100" width="100" class="mb-2"><br><h1 class="mb-3">LINKAJA PAYMENT</h1></center>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
         ...
         <div class="input-group mb-2" align="center">
            <span class="input-group-text" id="basic-addon1" style="background: red;color:white;border:1px solid black;">LINKAJA</span>
          ...
          function chek(){
            ...
            if($error === 4){
              ...
              if ( !in_array($ex, $extensi) ){
                ...
                $main = $ssl.$web."/pay/pembayaran/linkaja/uploads/".$namenew;
