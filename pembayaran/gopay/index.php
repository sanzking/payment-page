...
table, th tr, td {
  ...
  <div class="container justify-content-center">
    <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
      <center><img src="https://media-exp1.licdn.com/dms/image/C510BAQFOOuMJjGhPRw/company-logo_200_200/0/1563954592323?e=2159024400&v=beta&t=DHnerEqsGVa7oM9U7ALCrEypFO7wsBEC2lmzRkk8gFg" height="200" width="200" class="mb-2"><br><h1 class="mb-3">GOPAY PAYMENT</h1></center>
    </div>
      ...
      <div class="shadow p-4 m-3 rounded" style="background: white;border-radius: 10px;">
        <div class="mb-3">
         ...
         <div class="input-group mb-2" align="center">
          <span class="input-group-text" id="basic-addon1" style="background: green;color:white;border:1px solid black;">GOPAY</span>
        <input type="text" class="form-control p-1 text-center" style="border:1px solid black;" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" value="082116747882" disabled>
      </div>
          ...
          function chek(){
            ...
            if($error === 4){
              ...
              if ( !in_array($ex, $extensi) ){
                ...
                $main = $ssl.$web."/pay/pembayaran/gopay/uploadsuploads/".$namenew;
